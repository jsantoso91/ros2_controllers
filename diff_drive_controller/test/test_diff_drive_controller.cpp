...
TEST_F(TestDiffDriveController, expect_configure_succeededs_tf_test_prefix_false_no_namespace)
{
...
TEST_F(TestDiffDriveController, expect_configure_succeededs_tf_blank_prefix_true_no_namespace)
{
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
...
TEST_F(TestDiffDriveController, expect_configure_succeededs_tf_blank_prefix_true_set_namespace)
{
  std::string test_namespace = "/test_namespace";
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
